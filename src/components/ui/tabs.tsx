...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-14 items-center justify-center rounded-xl bg-muted p-1 text-muted-foreground shadow-sm",
      className,
    )}
    {...props}
  />
